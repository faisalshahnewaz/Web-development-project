				...
				<c:when test="${customer == null}">  
  				...
  				<c:otherwise>
	 				<!-- <li role="presentation"><a href="ChangePassword.do">Change Password</a></li> -->
	  				...
	  				<li role="presentation" class="active"><a href="SellFund.do">Sell Fund</a></li>
        ...
        <br>
				...
				<form class="form-horizontal" action="SellFund.do" method="POST">
  					<div class="form-group">
    					<label for="symbol" class="col-sm-4 control-label">Fund Symbol to Sell</label>
    					<div class="col-sm-8">
  					...
  					<div class="form-group">
              			<label for="fundname" class="col-sm-4 control-label">Fund Name</label>
               			<div class="col-sm-8">
                  			<input type="text" name="fundName" class="form-control" id="fundname" placeholder="Required">
              			</div>
            		</div>
            		<div class="form-group">
              			<label for="share" class="col-sm-4 control-label">Number of Shares to Sell</label>
               			<div class="col-sm-8">
                  			<input type="text" class="form-control" id="share" placeholder="number of shares">
              			</div>
            		</div>
  					<div class="form-group">
    					<div class="col-sm-offset-4 col-sm-8">
      						<button type="submit" name="action" value="SellFund" class="btn btn-primary">Confirm Fund to Sell</button>
                  			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
